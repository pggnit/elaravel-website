<?php /* C:\xampp\htdocs\elaravel-master\resources\views/admin_layout.blade.php */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								...
								</i> <?php echo e(Session::get('admin_name')); ?>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?php echo e(URL::to('/all-manufacture')); ?>"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Manufacture</span></a></li>
						<li><a href="<?php echo e(URL::to('/add-manufacture')); ?>"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Manufacture</span></a></li>
