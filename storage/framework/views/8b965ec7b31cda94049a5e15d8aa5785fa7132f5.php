<?php /* C:\xampp\htdocs\elaravel-master\resources\views/layout.blade.php */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +977 9862393885</a></li>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="<?php echo e(URL::to('/')); ?>"><img src="<?php echo e(URL::to('frontend/images/home/logo2.png')); ?>" alt="" /></a>
                        </div>
                         ...
                         <?php
                           $all_published_manufacture=DB::table('tbl_manufacture')
                            ...
                            foreach($all_published_manufacture as $v_manufacture){?>
                                    ...
                                    <li><a href="<?php echo e(URL::to('/product_by_manufacture/'.$v_manufacture->manufacture_id)); ?>"> <span class="pull-right">(50)</span><?php echo e($v_manufacture->manufacture_name); ?></a></li>
                         <?php } ?>
                                </ul>
                            </div>
                        </div><!--/brands_products-->
